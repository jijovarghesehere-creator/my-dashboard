...
// .wrangler/tmp/bundle-V2GIWF/checked-fetch.js
...
// .wrangler/tmp/pages-Lvokb8/functionsWorker-0.19963302486738288.mjs
...
var UPSTREAM = "https://news.google.com";
...
var UPSTREAM2 = "https://nominatim.openstreetmap.org";
async function onRequest2(context) {
  const url = new URL(context.request.url);
  const upstreamPath = url.pathname.replace(/^\/api\/nominatim/, "") || "/";
  const target = `${UPSTREAM2}${upstreamPath}${url.search}`;
  const upstream = await fetch(target, {
    headers: {
...
// .wrangler/tmp/bundle-V2GIWF/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-V2GIWF/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.19963302486738288.js.map
